 ...
 * RestTemplate se mockea para no depender de habitaciones-service (ni para la consulta de
 * datos de habitación al crear, ni para la sincronización de estado al hacer check-in/out).
 */
@SpringBootTest
@ActiveProfiles("test")
...
class ReservaIntegrationTest {
    ...
    void debePasarPorTodosLosEstados() {
        ...
        // Solo CHECKIN/CHECKOUT sincronizan el estado de la habitación; CONFIRMADA no.
